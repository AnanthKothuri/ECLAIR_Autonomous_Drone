...
from onnx_inference.bounding_box import BoundingBox
from onnx_inference.detected_objects import DetectedObject
...
class Images(BaseModel):
    ...
    def init_detected_objects(self, predictions: np.ndarray) -> None:
        ...
        for batch_id in batch_ids:
            ...
            predictions_for_batch_id = [i for i in predictions]
